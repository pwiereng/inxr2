...
POSTGRES_DB=inxr2
POSTGRES_USER=inxr2_user
POSTGRES_PASSWORD=<generate-a-strong-password>  # See "Generate secure values" above
POSTGRES_HOST=postgres
POSTGRES_PORT=5432
DATABASE_URL=postgresql://inxr2_user:<generate-a-strong-password>@postgres:5432/inxr2
PGDATA=/var/lib/postgresql/data/pgdata
...
SECRET_KEY=<generate-a-random-secret-key>  # See "Generate secure values" above
