"""
Indexing DTOs — request/response/progress objects for the indexing port.

These DTOs live in the application layer so that the port interface
(IndexingOrchestratorPort) does not depend on use-case implementations.
"""
