...
class RepositoryModel(Base, TimestampMixin):
    ...
    commits: Mapped[list["CommitModel"]] = relationship(
        "CommitModel", back_populates="repository", cascade="all, delete-orphan"
    )
    ...
    symbols: Mapped[list["SymbolModel"]] = relationship(
        "SymbolModel", back_populates="repository", cascade="all, delete-orphan"
    )
    references: Mapped[list["ReferenceModel"]] = relationship(
        "ReferenceModel",
        back_populates="repository",
        foreign_keys="ReferenceModel.repository_id",
