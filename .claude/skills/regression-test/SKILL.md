...
description: "Runs the full regression test suite: resets DB, re-indexes all repos, starts services, then runs all 36 browser/indexing tests via the QA agent. Runs autonomously without prompting."
user-invocable: true
